...
public class AdicionarProduto extends JPanel implements ActionListener{
    ...
    public AdicionarProduto(){
        ...
        JLabel label_preco = new JLabel ("Preco");
    ...
    public void actionPerforfomed(ActionEvent e) throws NotBoundException, MalformedURLException, RemoteException{
        ...
        try{
            InterfaceProduto produtoRemoto = (InterfaceProduto) Naming.lookup("rmi://192.168.1.105:1099/Produto");
